...
function A(t42) {
  ...
  for (const [r26, e28] of t42) a(e28) ? n25.set(r26, A(e28)) : n25.set(r26, e28);
  return n25;
}
function b(t42) {
  switch (true) {
...
function c2(n25 = true) {
  if (!n25 || !t) {
    ...
    let e28;
    for (let o28 = 0; o28 < n26.length; o28++) if (n26[o28].__vue__) {
      e28 = n26[o28];
      break;
    }
...
function w2() {
  ...
  }(), window.CDS._isStateProxied || (window.CDS._isStateProxied = true, window.CDS._state = new Proxy(window.CDS._state, {
    set: (e28, n25, o28) => {
      const t42 = {
        key: n25,
        prev: window.CDS._state[n25],
        current: o28
      };
      return e28[n25] = o28, document.dispatchEvent(new CustomEvent("CDS_STATE_UPDATE", {
        detail: t42
      })), true;
    }
  })));
...
function a4() {
  return {
    ...
    angularVersion: r2(false),
    angularJSVersion: i3(false),
    reactVersion: u2(false),
    vueVersion: c2(false),
    state: __spreadProps(__spreadValues({}, window.CDS._state), {
      iconRegistry: Object.keys(window.CDS._state.iconRegistry),
      motionRegistry: Object.keys(window.CDS._state.motionRegistry),
      focusTrapRegistry: Object.keys(window.CDS._state.focusTrapItems.map((e28) => e28.focusTrapId))
    })
  };
}
function d2() {
...
var n4 = curryN_default(3, (e28, t42, o28) => {
  n(e28) && !l2() ? n3.warn(e28 + " has already been registered") : (o28.define(e28, t42), w2(), window && !Object.keys(window.CDS._state.elementRegistry).some((t43) => t43 === e28) && (window.CDS._state.elementRegistry = __spreadProps(__spreadValues({}, window.CDS._state.elementRegistry), {
    [e28]: {}
  })));
});
function w3(e28, r26) {
...
var t3 = false;
function e3(t42) {
  if ((t42 = Math.trunc(t42) || 0) < 0 && (t42 += this.length), !(t42 < 0 || t42 >= this.length)) return this[t42];
}
if (!t3) {
  t3 = true;
  const r26 = Reflect.getPrototypeOf(Int8Array);
  for (const t42 of [Array, String, r26]) Object.defineProperty(t42.prototype, "at", {
    value: e3,
    writable: true,
    enumerable: false,
    configurable: true
...
var ReactiveElement = class extends HTMLElement {
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      ...
      } : ((_a4 = options.converter) === null || _a4 === void 0 ? void 0 : _a4.fromAttribute) !== void 0 ? options.converter : defaultConverter;
  ...
  switch (e28 ? e28.type : e28) {
    ...
    case Date:
      return __spreadValues({
        reflect: false,
        converter: {
          fromAttribute: (t43) => new Date(t43)
        }
      }, e28);
    default:
...
`;
      ...
      if ("error" === f9.required) throw Error(t44);
      n3.warn(t44, this);
    }
    l7 && l7.call(this, t43);
  };
...
function c5(r26, n25, o28) {
  ...
  n25.prepend(t42), render(r26, n25, __spreadValues({
    renderBefore: t42
  }, o28));
...
function f5(r26, n25, o28) {
  const t42 = document.createElement("div");
  n25.appendChild(t42), render(r26, n25, __spreadValues({
    renderBefore: t42
  }, o28));
  const i23 = t42.previousSibling;
  return t42.remove(), i23;
...
var h2 = class {
  ...
  triggerNativeButtonBehavior(s22) {
    if (this.host.disabled) t11(s22);
      ...
      i23?.dispatchEvent(new MouseEvent("click", {
...
__decorate([m2({
  type: Boolean
})], m3.prototype, "pressed", void 0), __decorate([m2({
  type: Boolean
})], m3.prototype, "expanded", void 0), __decorate([m2({
  type: Boolean
})], m3.prototype, "readonly", void 0), __decorate([m2({
  type: String
})], m3.prototype, "type", void 0), __decorate([m2({
  type: String
})], m3.prototype, "name", void 0), __decorate([m2({
  type: String
})], m3.prototype, "value", void 0), __decorate([m2({
  type: Boolean
})], m3.prototype, "disabled", null), __decorate([m2({
  type: String
})], m3.prototype, "popup", void 0), m3 = __decorate([t5(), t9(), s6(), t12(), t7(), t6(), r7(), t10()], m3);
...
function a7(e28) {
  e28 && !t13(e28) ? (e28.setAttribute("tabindex", "-1"), e28.focus(), e28.addEventListener("blur", () => e28.removeAttribute("tabindex"), {
    once: true
  })) : e28?.focus();
}
function d5(e28, t42) {
...
function t14(e28) {
  if (e28.documentElement) return e28.documentElement.children;
  if (e28.shadowRoot) return e28.shadowRoot.children;
...
var e9 = class {
  constructor(s22, t42 = {}) {
    this.host = s22, this.config = __spreadValues({
      escape: true,
      focusout: false
    }, t42), this.host.addController(this);
  }
  hostConnected() {
...
__decorate([p2({
  type: Boolean,
  reflect: true
})], p3.prototype, "demoMode", void 0), __decorate([p2({
  type: String
})], p3.prototype, "focusTrapId", void 0);
...
var decorateProperty = ({
  ...
  if (name !== void 0) {
    ...
    } : __spreadProps(__spreadValues({}, protoOrDescriptor), {
      key
    });
    if (finisher != void 0) {
...
__decorate([m2({
  type: String
})], v5.prototype, "shape", null), __decorate([m2({
  type: String
})], v5.prototype, "size", null), __decorate([m2({
  type: String
})], v5.prototype, "direction", void 0), __decorate([m2({
  type: String
})], v5.prototype, "flip", void 0), __decorate([m2({
  type: Boolean
})], v5.prototype, "solid", void 0), __decorate([m2({
  type: String
})], v5.prototype, "status", void 0), __decorate([m2({
  type: Boolean
})], v5.prototype, "inverse", void 0), __decorate([m2({
  type: String
})], v5.prototype, "badge", void 0), __decorate([p2({
  type: Number
})], v5.prototype, "innerOffset", void 0), __decorate([query("svg")], v5.prototype, "svg", void 0);
...
@lit/reactive-element/development/decorators/query.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LHJGLX4A.js.map
